...
const AboutPage: FC = () => {
  ...
  useEffect(() => {
    ...
    // Start the loading check asynchronously
    imagesLoaded(document.body).then(() => {
      setLoading(false); // Hide the loading screen once images are loaded
    });
  }, [location]);

  useEffect(() => {
    const initAnimations = () => {
      // Allow animations to start without waiting for images
    ...
    // Initialize animations regardless of whether the images are loaded
    initAnimations();
  }, [loading]);

  return (
    <>
      <div className={`about-page-content ${loading ? "loading" : ""}`}>
        ...
        >
          ...
          <div className="paragraph-co">
            <div className="paragraph">
              I was captivated by the simple UI and elegant design of macOS.
              That was the moment I knew I wanted to code and create software
              that was as simple and user-friendly as Apple's. This marked the
              beginning of my career as a coder.
            </div>
            <div className="paragraph">
              ...
              nothing fancy, just a basic layout with no real design, but it
              felt like a turning point. It was the first step into a world
              where I could bring ideas to life through code, and that made it
              unforgettable.
            </div>
          </div>
          <div className="paragraph-co">
            <div className="paragraph">
              <div className="paragraph-headline">Hobby to passion</div>I
              quickly made progress and soon started collaborating on real
              projects with a close friend. Building something from scratch was
              an incredible experience—it pushed my skills, fueled my
              creativity, and deepened my love for coding. Those moments opened
              my eyes to the endless possibilities of creating, designing, and
            ...
            <div className="paragraph">
              ...
              building, I hit the tennis court to stay sharp and competitive.
              And when I need to recharge, I lace up my running shoes—there’s
              nothing like a good run to clear my mind and find focus.
            </div>
          ...
          <div className="paragraph-co">
            ...
            <div className="paragraph">
              ...
              As I delved deeper into coding, I realized that functional code
              was only part of the equation. Inspired by Apple’s design
              philosophy, I explored UI and UX, discovering how details like
              fonts and spacing could transform the user experience. Design
              became more than aesthetics—it was about creating intuitive,
              seamless connections between people and technology.
            </div>
