    ...
    <>
      ...
      >
        <div className="figure figure1">
          <img
            className="image"
            src="../public/figures/figure1.HEIC"
            alt="Figure 1 - France 2024"
          />
          <img
            className="image image-mobile"
            src="../public/figures/figure3.HEIC"
            alt="Figure 1 - France 2024"
          />
        ...
        <div className="figure figure2">
          ...
          <img
            className="image"
            src="../public/figures/figure2.heic"
        ...
        <div className="paragraph-co">
          <div className="figure figure4">
            <img
              className="image"
              src="../public/figures/figure4.jpeg"
          ...
          <div className="figure figure6">
            <img
              className="image"
              src="../public/figures/figure6.jpeg"
